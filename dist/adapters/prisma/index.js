...
var Adapter = function Adapter(prismaConfig) {
          ...
          try {
            ...
            return prisma[User].update({
              ...
              data: {
                image,
                email,
                emailVerified: emailVerified && Object.prototype.toString.call(emailVerified) === '[object Date]' ? emailVerified.toISOString() : null,
                name
              }
            });
          } catch (error) {
          ...
          try {
            return prisma[Account].create({
              data: {
                accessToken,
                refreshToken,
                compoundId: (0, _crypto.createHash)('sha256').update("".concat(providerId, ":").concat(providerAccountId)).digest('hex'),
                providerAccountId: "".concat(providerAccountId),
                providerId,
                providerType,
                accessTokenExpires,
