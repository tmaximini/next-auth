    ...
    if (type === 'oauth') {
          ...
          var _ref2 = _asyncToGenerator(function* (error, profile, account, OAuthProfile) {
            try {
              ...
              if (useJwtSession) {
                ...
                var jwtPayload = yield callbacks.jwt(defaultJwtPayload, OAuthProfile, isNewUser);
      ...
      try {
        ...
        if (useJwtSession) {
          ...
          var jwtPayload = yield callbacks.jwt(defaultJwtPayload, account, isNewUser);
          var newEncodedJwt = yield jwt.encode(_objectSpread(_objectSpread({}, jwt), {}, {
            token: jwtPayload
          }));
          var cookieExpires = new Date();
      ...
      var _jwtPayload = yield callbacks.jwt(_defaultJwtPayload, userObjectReturnedFromAuthorizeHandler, false);
