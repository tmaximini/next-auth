...
var _default = (_ref) => {
  ...
  var withCallbackUrl = callbackUrl ? "?callbackUrl=".concat(callbackUrl) : '';
  var {
    email
  } = req.query;
  ...
  return (0, _preactRenderToString.default)((0, _preact.h)("div", {
    className: "signin"
  }, providersToRender.map((provider, i) => (0, _preact.h)("div", {
    key: provider.id,
    className: "provider"
  }, provider.type === 'oauth' && (0, _preact.h)("a", {
    className: "button",
    "data-provider": provider.id,
    href: "".concat(provider.signinUrl).concat(withCallbackUrl)
